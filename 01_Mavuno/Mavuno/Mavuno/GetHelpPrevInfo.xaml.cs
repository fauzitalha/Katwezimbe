...
namespace Mavuno
{
	...
	public partial class GetHelpPrevInfo : ContentPage
	{
        ...
        private GetHelpRequest GHR = new GetHelpRequest();
        #endregion

        #region ... 01: Class Constructor
        public GetHelpPrevInfo()
        {
            try
            {
                InitializeComponent();
        ...
        public GetHelpPrevInfo(ArrayList datatransfered)
        {
            try
            {
                InitializeComponent();
                ...
                GHR = (GetHelpRequest)datatransfered[3];
        ...
        {
            lblRqstRef.Text = GHR.XX_RECORD_ID;
            lblRqstDate.Text = GHR.ISSUE_DATE;
            lblPhoneNumber.Text = GHR.CUST_PHONE;

            lblEntPhone.Text = GHR.ENTERRED_PHONE;
            lblEntEmail.Text = GHR.ENTERRED_EMAIL;
            lblIssSubject.Text = GHR.ENTERRED_SUBJECT;
            lblIssDesc.Text = GHR.ENTERRED_ISSUE_DESC;
            lblIssStatus.Text = GHR.ISSUE_STATUS;
        }
        #endregion
