...
namespace Mavuno
{
	...
	public partial class SvgsAcctBalance : ContentPage
	{
        ...
        public SvgsAcctBalance(ArrayList datatransfered)
        {
            try
            {
                InitializeComponent();
                ...
                // ... DisplayScreenData
                lblTitleView.Text = "Balance: " + SAB.account_no;
        ...
        protected void DisplayAcctBalance()
        {
                ...
                else
                {
                    ...
                    if (RespCode.Equals("00"))
                    {
                        ...
                        if (MifosHttpRespcode.StartsWith("2"))
                        {
                            ...
                            string accountBalance = (MifosRespDetails.summary.accountBalance == null) ? "" : MifosRespDetails.summary.accountBalance.ToString("#,##0.00");

                            // ... assign to the display screen
                            lblSvgAcctNum.Text = AccountNum;
                            lblSvgAcctBal.Text = MifosRespDetails.currency.code + " " + accountBalance;
                        }
                        else
                        {
