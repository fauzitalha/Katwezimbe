...
namespace Mavuno
{
	...
	public partial class ShareAcctBuySharesNew : ContentPage
	{
        ...
        public ShareAcctBuySharesNew(ArrayList datatransfered)
        {
            try
            {
                InitializeComponent();
        ...
        private void BtnSubmit_Clicked(object sender, EventArgs e)
        {
            Device.BeginInvokeOnMainThread(async () =>
            {
                try
                {
                    using (UserDialogs.Instance.Loading("Submitting Buy Shares MoMo Request"))
                    {
                        await Task.Delay(300);
        ...
        #region ... 09: TxtShareNum_TextChanged
        private void TxtShareNum_TextChanged(object sender, TextChangedEventArgs e)
        {
            try
            {
                ...
                lblFundsToPick.Text = shr_value.ToString("#,##0.00");
