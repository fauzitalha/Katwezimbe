...
namespace Mavuno
{
	...
	public partial class GetHelp : ContentPage
	{
        ...
        public GetHelp(ArrayList datatransfered)
        {
            try
            {
                InitializeComponent();
        ...
        private async void OnRequestFrameTapped(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    await Navigation.PushAsync(new GetHelpNew(datatransfered));
                }
                else if (framename.Equals("Previous"))
                {
                    await Navigation.PushAsync(new GetHelpPrev(datatransfered));
                }
                else
                {
