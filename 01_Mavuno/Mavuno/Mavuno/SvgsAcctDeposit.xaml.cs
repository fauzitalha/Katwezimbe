...
namespace Mavuno
{
	...
	public partial class SvgsAcctDeposit : ContentPage
	{
        ...
        public SvgsAcctDeposit(ArrayList datatransfered)
        {
            try
            {
                InitializeComponent();
                ...
                // ... DisplayWalletData
                lblTitleView.Text = "Deposit: " + SAB.account_no;
            }
            catch (Exception mm)
            {
        ...
        private void OnRequestFrameTapped(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Navigation.PushAsync(new SvgsAcctDepositNew(datatransfered));
                }
                else if (framename.Equals("Previous"))
                {
                    Navigation.PushAsync(new SvgsAcctDepositPrev(datatransfered));
                }
                else
                {
