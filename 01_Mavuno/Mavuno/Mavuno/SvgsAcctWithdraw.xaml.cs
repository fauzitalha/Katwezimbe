...
namespace Mavuno
{
	...
	public partial class SvgsAcctWithdraw : ContentPage
	{
        ...
        public SvgsAcctWithdraw(ArrayList datatransfered)
        {
            try
            {
                InitializeComponent();
                ...
                // ... DisplayWalletData
                lblTitleView.Text = "Withdraw: " + SAB.account_no;
            }
            catch (Exception mm)
            {
        ...
        private void OnRequestFrameTapped(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Navigation.PushAsync(new SvgsAcctWithdrawNew(datatransfered));
                }
                else if (framename.Equals("Previous"))
                {
                    Navigation.PushAsync(new SvgsAcctWithdrawPrev(datatransfered));
                }
                else
                {
