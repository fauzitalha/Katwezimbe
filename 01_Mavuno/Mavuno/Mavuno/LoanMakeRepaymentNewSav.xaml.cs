...
namespace Mavuno
{
	...
	public partial class LoanMakeRepaymentNewSav : ContentPage
	{
        ...
        public LoanMakeRepaymentNewSav()
        {
            try
            {
                InitializeComponent();
        ...
        public LoanMakeRepaymentNewSav(ArrayList datatransfered)
        {
            try
            {
                InitializeComponent();
        ...
        protected void DisplayCustSavingsAccts()
        {
            Device.BeginInvokeOnMainThread(async () =>
            {
                try
                {
                    ...
                    using (UserDialogs.Instance.Loading("LOAN REPAYMENT: Fetching savings accounts"))
                    {
        ...
        private void OnSavingsAccountSelected(object sender, SelectedItemChangedEventArgs e)
        {
            try
            {
                ...
                Navigation.PushAsync(new LoanMakeRepaymentNewSav2(datatransfered));
            }
            catch (Exception mm)
            {
                DisplayAlert("Error 02", mm.Message, "OK");
