...
namespace Mavuno
{
	...
	public partial class SvgsAcctStmtRequestPrevInfo : ContentPage
	{
        ...
        private StmtRqst STMT_RQST = new StmtRqst();
        #endregion

        #region ... 01: Class Constructor
        public SvgsAcctStmtRequestPrevInfo()
        {
            try
            {
                InitializeComponent();
        ...
        public SvgsAcctStmtRequestPrevInfo(ArrayList datatransfered)
        {
            try
            {
                InitializeComponent();
                ...
                STMT_RQST = (StmtRqst)datatransfered[4];
        ...
        {
            lblRqstRef.Text = STMT_RQST.RECORD_ID;
            lblStmtPeriod.Text = "From: " + STMT_RQST.START_DATE + " - To: " + STMT_RQST.END_DATE;
            lblEmail.Text = STMT_RQST.DELIVERY_EMAIL;
            lblRqstStatus.Text = STMT_RQST.RQST_STATUS;
            lblAddtRmks.Text = STMT_RQST.APPRVL_RMKS;
        }
        #endregion
