...
using MTNOpenApi_Disbursements_PostTransfer_Service.Core;
...
namespace MTNOpenApi_Disbursements_PostTransfer_Service.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PostDisbursementTransferController : ControllerBase
    {
