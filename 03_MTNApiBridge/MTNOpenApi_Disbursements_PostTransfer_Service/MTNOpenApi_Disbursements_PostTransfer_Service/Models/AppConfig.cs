namespace MTNOpenApi_Disbursements_PostTransfer_Service.Models
{
    public class AppConfig
    {
        ...
        public static string DISBURSEMENTS_POSTTRANSFER_URL_KEY = appconfig["URL_SETTINGS:DISBURSEMENTS_POSTTRANSFER_URL:KEY"];
        public static string DISBURSEMENTS_POSTTRANSFER_URL_KEY_FIELD = appconfig["URL_SETTINGS:DISBURSEMENTS_POSTTRANSFER_URL:KEY_FIELD"];
        ...
        public static string DISBURSEMENTS_POSTTRANSFER_MSGTEMPLATE_KEY = appconfig["REQUEST_MSGS:DISBURSEMENTS_POSTTRANSFER_MSGTEMPLATE:KEY"];
        public static string DISBURSEMENTS_POSTTRANSFER_MSGTEMPLATE_KEY_FIELD = appconfig["REQUEST_MSGS:DISBURSEMENTS_POSTTRANSFER_MSGTEMPLATE:KEY_FIELD"];
