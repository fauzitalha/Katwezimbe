...
using MTNOpenApi_Disbursements_GetTranDetails_Service.Core;
...
namespace MTNOpenApi_Disbursements_GetTranDetails_Service.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class DisbursementstrandetailsController : ControllerBase
    {
