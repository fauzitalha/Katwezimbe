...
namespace MTNOpenApi_Disbursements_GetTranDetails_Service.Core
{
    public class MTNOpenApiHelper
    {
        ...
        public Dictionary<string, dynamic> GetTranDetails_Disbursements(string authtoken, string targetEnvironment, string disbursementsSubKey, string url)
        {
            ...
            try
            {
                ...
                client.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", disbursementsSubKey);
                ...
                respProcMessage.Add("AuthProcRef", "");
