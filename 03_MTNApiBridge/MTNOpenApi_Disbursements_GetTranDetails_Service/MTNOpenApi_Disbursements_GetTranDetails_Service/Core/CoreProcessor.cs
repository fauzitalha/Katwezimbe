using MTNOpenApi_Disbursements_GetTranDetails_Service.Models;
using Newtonsoft.Json.Linq;

namespace MTNOpenApi_Disbursements_GetTranDetails_Service.Core
{
    public class CoreProcessor
    {
        ...
        internal Dictionary<string, dynamic> ProcessWebRequest(object origRequest)
        {
            ...
            try
            {
                ...
                string disbursements_GetTranDetails_URL_Template = RedisHelper.ReadData_HASH(AppConfig.DISBURSEMENTS_GETTRANDETAILS_URL_KEY, AppConfig.DISBURSEMENTS_GETTRANDETAILS_URL_KEY_FIELD);
                ...
                string disbursements_GetTranDetails_URL = CoreHelpers.PopulateStringTemplate(disbursements_GetTranDetails_URL_Template, mtnRequestParams);
                #region ... <logging />
                ...
                logMessage = "disbursements_GetTranDetails_URL_Template: " + disbursements_GetTranDetails_URL_Template;
                applogger.LogToFile(logmsg, logmsg.LOG_LEVEL, logmsg.FUNCTION, logMessage);

                logMessage = "disbursements_GetTranDetails_URL: " + disbursements_GetTranDetails_URL;
                applogger.LogToFile(logmsg, logmsg.LOG_LEVEL, logmsg.FUNCTION, logMessage);
                #endregion
                ...
                Dictionary<string, dynamic> respProcMessage = moah.GetTranDetails_Disbursements(accessToken_Disbursements, targetEnvironment, subKey_Primary_Disbursements, disbursements_GetTranDetails_URL);
