...
namespace MTNOpenApi_Collections_RequestToPay_Service.Core
{
    public class MTNOpenApiHelper
    {
        ...
        public Dictionary<string, dynamic> InitiateRequestToPay(string authtoken, string xRefId, string targetEnvironment, string collectionsSubKey, string url, string requestMessage)
        {
            ...
            try
            {
                ...
                ////////////    Console.WriteLine("RESP_IS_SUCCESS: " + http_IsSuccessStatusCode);
                ////////////    Console.WriteLine("RESP_VERSION: " + http_Version);
                ////////////    Console.WriteLine("RESP_CODE: " + http_status_code);
                ////////////    Console.WriteLine("RESP_CONT: " + resp_content);
                ////////////}
                #endregion
