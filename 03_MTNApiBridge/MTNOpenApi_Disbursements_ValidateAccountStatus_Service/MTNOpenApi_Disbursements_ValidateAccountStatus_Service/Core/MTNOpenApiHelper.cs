...
namespace MTNOpenApi_Disbursements_ValidateAccountStatus_Service.Core
{
    public class MTNOpenApiHelper
    {
        ...
        #region ... 01: DisbursementsValidateAccountStatus
        public Dictionary<string, dynamic> DisbursementsValidateAccountStatus(string authtoken, string targetEnvironment, string subKey, string url)
        {
