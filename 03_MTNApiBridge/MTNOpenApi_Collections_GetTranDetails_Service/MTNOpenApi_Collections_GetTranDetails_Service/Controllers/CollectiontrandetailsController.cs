...
using MTNOpenApi_Collections_GetTranDetails_Service.Core;
...
namespace MTNOpenApi_Collections_GetTranDetails_Service.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CollectiontrandetailsController : ControllerBase
    {
