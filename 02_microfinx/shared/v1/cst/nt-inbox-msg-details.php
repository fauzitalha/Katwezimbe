...
for ($i = 0; $i < sizeof($rcp_list); $i++) {
  ...
  $type = "";
  if ($ADDRESS_ENTITY_TYPE == "USER") {
    $type = " [SACCO staff]";
  }
  if ($ADDRESS_ENTITY_TYPE == "GROUP") {
    $type = " [Group]";
  }
...
$CURRENT_USER = $_SESSION['CST_USR_ID'];
$has_been_read = DetermineIffRead($CURRENT_USER, $M_NTFCN_ID);
if ($has_been_read == "NN") {
  $RR_NTFCN_ID = $M_NTFCN_ID;
  $RR_RECIPIENT_ID = $CURRENT_USER;
  $RR_READ_FLG = "YY";
  $RR_READ_DATE = GetCurrentDateTime();

  $q = "INSERT INTO notification_read_receipt(NTFCN_ID, RECIPIENT_ID, READ_FLG, READ_DATE) VALUES('$RR_NTFCN_ID', '$RR_RECIPIENT_ID', '$RR_READ_FLG', '$RR_READ_DATE')";
...
if (isset($_POST['btn_trash_email'])) {
  ...
  // ... SQL
  $q = "UPDATE notification_read_receipt SET DEL_FLG='Y' WHERE NTFCN_ID='$M_NTFCN_ID' AND RECIPIENT_ID='$RECIPIENT_ID'";
  ...
  if ($update_response == "EXECUTED") {
    ...
    if ($exec_response["RESP"] == "EXECUTED") {
      ...
      $EVENT = "TRASH_NTFCN";
      $EVENT_OPERATION = "TRASH_NTFCN_FOR_PARTICULAR_READER";
      $EVENT_RELATION = "notification_read_receipt";
      $EVENT_RELATION_NO = $M_NTFCN_ID . "|" . $RECIPIENT_ID . "|" . $M_NTFCN_THREAD_ID;
      $OTHER_DETAILS = $M_NTFCN_ID . "|" . $RECIPIENT_ID . "|" . $M_NTFCN_THREAD_ID;
...
<head>
  ...
  ?>
  <link rel="stylesheet" type="text/css" href="build/inbox.css">
</head>
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="x_panel">
            <div class="x_title">
              <a href="nt-inbox" class="btn btn-sm btn-dark pull-left">Back</a>
              ...
              ?>
                <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                  ...
                  for ($i = 0; $i < sizeof($thread_list); $i++) {
                    ...
                    # ... Determine if the thread was deleted by current reader
                    $ENTITY_ID = $_SESSION['CST_USR_ID'];
                    $thd_del_flg = CheckIFFThreadIsDeleted($M_NTFCN_THREAD_ID, $M_NTFCN_ID, $ENTITY_ID);
                    if ($thd_del_flg == "YY") {
                      // ... do nothing
                    } else if ($thd_del_flg == "NN") {
                  ?>
                      <div class="panel">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              ...
                              ?>
                                ...
                                <table>
                                  ...
                                  <?php
                                  $NTFCN_FILE_ACCESS_PATH_CUST = GetSystemParameter("NTFCN_FILE_ACCESS_PATH_CUST") . "/" . $_SESSION['ORG_CODE'];
                                  ...
                                  for ($u = 0; $u < sizeof($attmt_list); $u++) {
                                    ...
                                    $data_transfer = $NTFCN_FILE_ACCESS_PATH_CUST . "/" . $FL_NTFCN_ID . "/" . $FL_ATTCHMT_NAME;
                                  ...
                                  ?>
                                    <tr valign="top">
                                      ...
                                      <td>
                                        ...
                                        <a href="<?php echo $data_transfer; ?>" class="btn btn-default btn-xs pull-right"><i class="fa fa-download"></i> Download</a>
                                      </td>
                                    </tr>
                                  <?php
                                  }
