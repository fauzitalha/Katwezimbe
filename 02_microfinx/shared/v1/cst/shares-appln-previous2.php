            ...
            <div class="x_panel">
              ...
              <div class="x_content">         
               <table id="datatable" class="table table-striped table-bordered" style="font-size: 11px;">
                  <thead>
                    <tr valign="top">
                      <th colspan="9" bgcolor="#EEE">List of pending buy shares applns</th>
                    </tr>
                    <tr valign="top">
                      <th>#</th>
                      <th>Appln Ref</th>
                  ...
                  <tbody>
                    ...
                    $shr_list = array();
                    $shr_list = FetchCustPreviousShareRequestApplns($CUST_ID, $START_DATE, $END_DATE);
                    ...
                    for ($i=0; $i < sizeof($shr_list); $i++) {
                      ...
                      <tr valign="top">
                        ...
                        <td>
                          <a href="shares-appln-previous3?k=<?php echo $data_transfer; ?>" class="btn btn-primary btn-xs">View</a>
                        </td>
                      </tr>
                      <?php
                    }
