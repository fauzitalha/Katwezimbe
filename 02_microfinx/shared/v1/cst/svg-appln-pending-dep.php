              ...
              <div class="x_content">         
                ...
                <table id="datatable" class="table table-striped table-bordered" style="font-size: 11px;">
                  ...
                  <tbody>
                    <?php
                    $sd_list = array();
                    $sd_list = FetchCustPendingSavingsDepositApplns($_SESSION["CST_USR_ID"]);
                    ...
                    for ($i=0; $i < sizeof($sd_list); $i++) {
                      ...
                      <tr valign="top">
                        ...
                        <td>
                          <a href="svg-appln-pending-dep-ind?k=<?php echo $data_transfer; ?>" class="btn btn-primary btn-xs">View</a>
                        </td>
                      </tr>
                      <?php
                    }
