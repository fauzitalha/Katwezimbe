      ...
      <div class="col-md-8 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <h2>New Request (Existing Membership)</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <input type="text" id="personal_id_doc_no" name="personal_id_doc_no" class="form-control">
                    ...
                    <input type="text" id="nat_id_nin" name="nat_id_nin" class="form-control">
