...
if (isset($_POST['btn_grrt_proc'])) {
  ...
  $LN_APPLN_NO = trim(mysql_real_escape_string($_POST['LN_APPLN_NO']));
  $LN_APPLN_PROGRESS_STATUS = "3";

  # ... SQL
  $q2 = "UPDATE loan_applns SET LN_APPLN_PROGRESS_STATUS='$LN_APPLN_PROGRESS_STATUS' WHERE LN_APPLN_NO='$LN_APPLN_NO'";
  $update_response = ExecuteEntityUpdate($q2);
  
  $next_page = "la-new-appln5?k=$LN_APPLN_NO";
