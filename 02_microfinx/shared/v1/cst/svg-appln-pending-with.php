            ...
            <div class="x_panel">
              ...
              <div class="x_content">         
                <table id="datatable" class="table table-striped table-bordered" style="font-size: 11px;">
                  <thead>
                    <tr valign="top">
                      <th colspan="9" bgcolor="#EEE">My pending withdraw applications</th>
                    </tr>
                    <tr valign="top">
                      <th>#</th>
                      <th>Appln Ref</th>
                  ...
                  <tbody>
                    <?php
                    $sw_list = array();
                    $sw_list = FetchCustPendingSavingsWithdrawAppln($_SESSION["CST_USR_ID"]);
                    ...
                    for ($i=0; $i < sizeof($sw_list); $i++) {
                      ...
                      <tr valign="top">
                        ...
                        <td>
                          <a href="svg-appln-pending-with-ind?k=<?php echo $data_transfer; ?>" class="btn btn-primary btn-xs">View</a>
                        </td>
                      </tr>
                      <?php
                    }
