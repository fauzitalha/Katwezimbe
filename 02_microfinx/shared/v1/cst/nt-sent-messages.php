...
<html>
  <head>
    ...
    LoadDeviceSettings(); 
    LoadDefaultCSSConfigurations("Sent Messages", $APP_SMALL_LOGO); 
              ...
              <div class="x_content">         
                <table id="datatable" class="table">
                  ...
                  <tbody>
                    ...
                    $notif_list = array();
                    $notif_list = FetchSentMessages($SENDER_ID);
                    ...
                    for ($i=0; $i < sizeof($notif_list); $i++) { 
                      ...
                      <tr>
                        <td></td>
                        <td>
                          <a href="nt-sent-msg-details?k=<?php echo $data_transfer; ?>">
                            <strong style="font-size: 14px;"><?php echo $SENDER_NAME; ?></strong> <?php echo $thd_cnt_disp; ?><br>
                            <?php echo $ATT_DISP; ?>
