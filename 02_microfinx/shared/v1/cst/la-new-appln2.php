...
if (isset($CORE_RESP["mobileNo"])) {
  $CST_mobileNo = $CORE_RESP["mobileNo"];
}
...
$response_msg = FetchClientOtherDetails($CLIENT_ID, $MIFOS_CONN_DETAILS);
$CONN_FLG = $response_msg["CONN_FLG"];
$CORE_RESP = $response_msg["CORE_RESP"];
...
$response_msg = FetchClientDocuments($CLIENT_ID, $MIFOS_CONN_DETAILS);
$CONN_FLG = $response_msg["CONN_FLG"];
$CORE_RESP = $response_msg["CORE_RESP"];
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              <div class="x_title">
                <a href="la-new-appln" class="btn btn-dark btn-sm pull-left">Back</a>
              ...
              <div class="x_content">
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                    ...
                    <input type="text" class="form-control" disabled="" value="<?php echo $cust_id_acct; ?>">
                  </div>

                  <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                    <label>Customer Full Name</label>
                    <input type="text" class="form-control" disabled="" value="<?php echo $displayName; ?>">
                  </div>
                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      for ($i=0; $i < sizeof($client_doc_list); $i++) { 
                        ...
                        $DOCUMENT_ID = $doc_id;
                        $doc_url = FetchDownloadClientDocument($CLIENT_ID, $DOCUMENT_ID, $MIFOS_CONN_DETAILS)
                        ?>
                        <tr valign="top">
                          <td><?php echo ($i+1); ?>. </td>
               ...
               <table class="table table-striped table-bordered">
                 ...
                 <tr><td colspan="2">
                  ...
                  if ($SYS_RMKS["PROC"]=="OK") {
                    ...
                    <a href="la-new-appln3?k=<?php echo $pdt_id."-".$pdt_name; ?>" class="btn btn-success btn-sm pull-right">Continue</a>
                    <?php
