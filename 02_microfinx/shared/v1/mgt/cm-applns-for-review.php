...
<html>
  <head>
    ...
    LoadDeviceSettings(); 
    LoadDefaultCSSConfigurations("Applns 4 Review", $APP_SMALL_LOGO); 
            ...
            <div class="x_panel">
              ...
              <div class="x_content">         
                ...
                <table id="datatable" class="table table-striped table-bordered" style="font-size: 11px;">
                  <thead>
                    <tr valign="top">
                      <th colspan="10" bgcolor="#EEE">List of Appln that have been forwarded to the customer for review.</th>
                    </tr>
                    <tr valign="top">
                      <th>#</th>
                      <th>Regn. Date</th>
                  ...
                  <tbody>
                    ...
                    $cstmr_actvn_list = FetchActivationRequestsByStatus($ACTIVATION_STATUS);
                    ...
                    for ($i=0; $i < sizeof($cstmr_actvn_list); $i++) {
                      ...
                      <tr valign="top">
                        ...
                        <td>
                          <a href="cm-applns-for-review-details?k=<?php echo $data_transfer; ?>" class="btn btn-primary btn-xs">View</a>
                        </td>
                      </tr>
