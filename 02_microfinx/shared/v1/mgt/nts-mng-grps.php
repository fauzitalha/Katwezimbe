...
if (isset($_POST['btn_create_group'])) {
  ...
  $GRP_TYPE_ID = trim(mysql_real_escape_string($_POST['GRP_TYPE_ID']));
  $DATE_CREATED = GetCurrentDateTime(); 
  $CREATED_BY = $_SESSION['UPR_USER_ID'];

  $q = "INSERT INTO notification_groups(GRP_NAME,GRP_TYPE_ID,DATE_CREATED,CREATED_BY) VALUES('$GRP_NAME','$GRP_TYPE_ID','$DATE_CREATED','$CREATED_BY')";
  $exec_response = array();
  ...
  $q2 = "UPDATE notification_groups SET GRP_ID='$GRP_ID' WHERE RECORD_ID='$RECORD_ID'";
  ...
  if ($update_response=="EXECUTED") {
    ...
    $EVENT = "CREATE";
    $EVENT_OPERATION = "CREATE_NEW_GROUP";
...
if (isset($_POST['btn_disable_group'])) {
  ...
  # ... SQL
  $q = "UPDATE notification_groups SET GRP_STATUS='$GRP_STATUS' WHERE RECORD_ID='$RECORD_ID'";
  ...
  if ($update_response=="EXECUTED") {
    ...
    $EVENT = "DISABLE";
    $EVENT_OPERATION = "DISABLE_NOTIF_GROUP";
    $EVENT_RELATION = "notification_groups";
    $EVENT_RELATION_NO = $RECORD_ID;
    $OTHER_DETAILS = "";
    $INVOKER_ID = $_SESSION['UPR_USER_ID'];
...
if (isset($_POST['btn_reenable_group'])) {
  ...
  if ($update_response=="EXECUTED") {
    ...
    $ENTITY_ID_AFFECTED =$_POST['ADD_RECORD_ID'];
    $EVENT = "RE_ENABLE";
    $EVENT_OPERATION = "RE_ENABLE_NOTIF_GROUP";
    $EVENT_RELATION = "notification_groups";
    $EVENT_RELATION_NO = $RECORD_ID;
    $OTHER_DETAILS = "";
    $INVOKER_ID = $_SESSION['UPR_USER_ID'];
...
if (isset($_POST['btn_delete_group'])) {
  ...
  $grp = array();
  $grp = FetchGroupByRecordId($RECORD_ID);
  ...
  $q = "INSERT INTO notification_groups_deleted(RECORD_ID,GRP_ID, GRP_TYPE_ID, GRP_NAME, DATE_CREATED,CREATED_BY,GRP_STATUS) VALUES('$RECORD_ID','$GRP_ID','$GRP_TYPE_ID','$GRP_NAME','$DATE_CREATED','$CREATED_BY','$GRP_STATUS');";
  $exec_response = array();
  $exec_response = ExecuteEntityInsert($q);
  $RESP = $exec_response["RESP"]; 
  $RECORD_ID = $exec_response["RECORD_ID"];
  if ( $RESP=="EXECUTED" ) {
    ...
    if ($DEL_FLG=="Y") {
      ...
      $ENTITY_ID_AFFECTED = $GRP_ID;
      $EVENT = "DELETE";
      $EVENT_OPERATION = "DELETE_NOTIF_GROUP";
      $EVENT_RELATION = "notification_groups -> notification_groups_deleted";
      ...
      $alert_type = "SUCCESS";
      $alert_msg = "MESSAGE: Notification group has been deleted completely. Refreshing in 5 seconds.";
      $_SESSION['ALERT_MSG'] = SystemAlertMessage($alert_type, $alert_msg);
      header("Refresh:5;");
    }
...
<html>
  <head>
    ...
    LoadDeviceSettings(); 
    LoadDefaultCSSConfigurations("Notfcn. Groups", $APP_SMALL_LOGO); 
              ...
              <div class="x_content">         
                ...
                <table id="datatable" class="table table-striped table-bordered">
                  <thead>
                    <tr valign="top">
                      <th colspan="7" bgcolor="#EEE">
                          <span style="font-size: 16px;">Current Groups</span>
                              ...
                              <div class="modal-content" style="color: #333;">
                                ...
                                <div class="modal-body">
                                    <form id="dddqwqqw2" method="post">
                                      ...
                                      <select id="GRP_TYPE_ID" name="GRP_TYPE_ID" class="form-control" required="">
                                        <option value="">Select Group Type</option>
                                        <?php
                                        $grp_type_list = array();
                                        $grp_type_list = FetchGroupTypeList("ACTIVE");
                                        for ($i=0; $i < sizeof($grp_type_list); $i++) { 
                                          $grp_type = array();
                                          $grp_type = $grp_type_list[$i];
                                          $GRP_TYPE_ID = $grp_type['GRP_TYPE_ID'];
                                          $GRP_TYPE_NAME = $grp_type['GRP_TYPE_NAME'];
                                          ?>
                                          <option value="<?php echo $GRP_TYPE_ID; ?>"><?php echo $GRP_TYPE_NAME; ?></option>
                                          <?php
                                        }
                                        ?>
                  ...
                  <tbody>
                    ...
                    $GRP_STATUS = "";
                    $grp_list = array();
                    $grp_list = FetchGroupList($GRP_STATUS);
                      ...
                      <tr valign="top">
                        ...
                        <td>
                          ...
                          if ($GRP_STATUS=="ACTIVE") {
                            ?>
                            <a href="nts-mng-grps-ind?k=<?php echo $datatotransfer; ?>" class="btn btn-xs btn-primary">Manage</a>
