...
<html>
  <head>
    ...
    LoadDeviceSettings(); 
    LoadDefaultCSSConfigurations("Approved Withdraw List", $APP_SMALL_LOGO); 
            ...
            <div class="x_panel">
              ...
              <div class="x_content"> 
                <table class="table table-striped table-bordered" style="font-size: 11px;">
                  <tr bgcolor="#EEE"><th colspan="2">Savings withdraw applications approved between;</th></tr>
                ...
                <table id="datatable" class="table table-striped table-bordered" style="font-size: 11px;">
                  ...
                  <tbody>
                    ...
                    $sw_list = array();
                    $sw_list = FetchSavingsWithdrawApplnsBtnPeriods($START_DATE, $END_DATE);
                    ...
                    $_SESSION["EXCEL_HEADER"] = array("#","Appln Ref","Client Name","Amount","Intrnl Acct No","Approval Date","Extrnl Acct No","Extrnl Orgn");
                    $_SESSION["EXCEL_DATA"] = $excel_table_list;
                    $_SESSION["EXCEL_FILE"] = "SavingsWithdrawalList_".date('dFY', strtotime(GetCurrentDateTime())).".xlsx";
                    ?>
                  </tbody>
                </table>
              </div>
