...
<html>
  <head>
    ...
    LoadDeviceSettings(); 
    LoadDefaultCSSConfigurations("Approve Applications", $APP_SMALL_LOGO); 
            ...
            <div class="x_panel">
              ...
              <div class="x_content">         
                ...
                <table id="datatable" class="table table-striped table-bordered" style="font-size: 11px;">
                  <thead>
                    <tr valign="top">
                      <th colspan="11" bgcolor="#EEE">List of Applications that need approval</th>
                    </tr>
                    <tr valign="top">
                      <th>#</th>
                      <th>Regn. Date</th>
                  ...
                  <tbody>
                    ...
                    for ($i=0; $i < sizeof($cstmr_actvn_list); $i++) {
                      ...
                      <tr valign="top">
                        ...
                        <td>
                          <a href="cm-apprv-applns-details?k=<?php echo $data_transfer; ?>" class="btn btn-primary btn-xs">View</a>
                        </td>
                      </tr>
