...
if (isset($loan_appln['RECORD_ID'])) {
  ...
  $IS_WALK_IN = $loan_appln['IS_WALK_IN'];
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              <div class="x_title">
                ...
                <a href="la-new-appln-walkin4?k=<?php echo $LN_APPLN_NO; ?>" class="btn btn-primary btn-sm pull-right">Continue</a>
            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <table class="table table-bordered" style="font-size: 12px;">
                  ...
                  <tr><td><b>This is a walkin/b></td><td><?php echo $IS_WALK_IN; ?><td></tr>
