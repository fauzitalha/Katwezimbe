...
<html>
  <head>
    ...
    LoadDeviceSettings(); 
    LoadDefaultCSSConfigurations("New Loan Applications", $APP_SMALL_LOGO); 
            ...
            <div class="x_panel">
              ...
              <div class="x_content">         
                ...
                <table id="datatable" class="table table-striped table-bordered" style="font-size: 11px;">
                  <thead>
                    <tr valign="top">
                      <th colspan="9" bgcolor="#EEE">List of New Loan Applications</th>
                    </tr>
                    <tr valign="top">
                      <th>#</th>
                      <th>Appln Ref</th>
                  ...
                  <tbody>
                    ...
                    $B_LN_APPLN_STATUS = "CC_BOUNCED_BACK";
                    $la_list_b = array();
                    $la_list_b = FetchLoanApplns($B_LN_APPLN_STATUS);

                    $C_LN_APPLN_STATUS = "AA_BOUNCED_BACK";
                    $la_list_c = array();
                    $la_list_c = FetchLoanApplns($C_LN_APPLN_STATUS);

                    

                    $la_full_list = array_merge($la_list, $la_list_b, $la_list_c);
                    for ($i=0; $i < sizeof($la_full_list); $i++) {
                      $la = array();
                      $la = $la_full_list[$i];
                      ...
                      <tr valign="top">
                        ...
                        <td>
                          <a href="la-queue-ind?k=<?php echo $data_transfer; ?>" class="btn btn-primary btn-xs">View</a>
                        </td>
                      </tr>
                      <?php
