...
$vfd_full_name = "";
$USER_DETAILS = array();
$USER_DETAILS = GetUserDetailsFromPortal($HANDLED_BY);
...
$apprv_full_name = "";
$USER_DETAILS = array();
$USER_DETAILS = GetUserDetailsFromPortal($APPRVD_BY);
if (isset($USER_DETAILS['USER_CORE_ID'])) {
  $VFD_USER_CORE_ID = $USER_DETAILS['USER_CORE_ID'];
  $response_msg = FetchUserDetailsFromCore($VFD_USER_CORE_ID, $MIFOS_CONN_DETAILS);
  $CONN_FLG = $response_msg["CONN_FLG"];
            ...
            <div class="x_panel">
              ...
              <div class="x_content">         
                <table class="table table-bordered" style="font-size: 12px;">
                  ...
                  <tr><td><b>Verified By</b></td><td colspan="3"><?php echo $vfd_full_name; ?></td></tr>
                  <tr>
                  ...
                  <tr><td><b>Approved By</b></td><td colspan="3"><?php echo $apprv_full_name; ?></td></tr>
