      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              <div class="x_title">
                <a href="la-new-appln-walkin0" class="btn btn-dark btn-sm pull-left">Back</a>
              ...
              <div class="x_content">  
                ...
                $response_msg = FetchLoanProducts_Walkin($MIFOS_CONN_DETAILS);
                        ...
                        <div class="tab-pane <?php echo $active; ?>" id="<?php echo $collapse_id; ?>">
                          <fieldset style="border: solid; size: 1px; 
                            ...
                            <p>
                              ...
                              <a href="la-new-appln-walkin2?k=<?php echo $pdt_id."-".$pdt_name."-".$CUST_CORE_ID; ?>" class="btn btn-success btn-sm pull-right">SELECT: <?php echo strtoupper($pdt_name); ?></a>
                            </p>
                          </fieldset>
                        </div>
                        <?php
