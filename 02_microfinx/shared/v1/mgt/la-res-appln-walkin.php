      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              <div class="x_title">
                <h2>Resume Walk in Loan Application</h2>
              ...
              <div class="x_content">         
                ...
                <table id="datatable" class="table table-striped table-bordered">
                  <thead>
                    <tr valign="top">
                      <th colspan="7" bgcolor="#EEE">List of Incomplete Walkin Loan Applications</th>
                    </tr>
                    <tr valign="top">
                      <th>#</th>
                      <th>Loan Appln No</th>
                  ...
                  <tbody>
                    ...
                    $loan_appln_list = FetchLoanApplnsByStatus_walkin($LN_APPLN_STATUS);
                    for ($i=0; $i < sizeof($loan_appln_list); $i++) { 
                      ...
                      $lnprog = array();
                      $lnprog = FetchLoanApplnProgress_walkin($LN_APPLN_PROGRESS_STATUS);
                      ...
                      if ($LN_APPLN_PROGRESS_STATUS==1) {
                        $next_doc = "la-new-appln-walkin4?k=$data_transfer";
