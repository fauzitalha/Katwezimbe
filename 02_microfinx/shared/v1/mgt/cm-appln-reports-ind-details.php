...
<html>
  <head>
    ...
    LoadDeviceSettings(); 
    LoadDefaultCSSConfigurations("Appln Details", $APP_SMALL_LOGO); 
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              <div class="x_title">
                <h2>Appln Details <small><?php echo $ACTIVATION_REF; ?></small></h2>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-8 col-sm-6 col-xs-12">
                    <table class="table table-bordered">
                      ...
                      <tr valign="top"><th>Completn Date</th><td><?php echo $OAA_DATE; ?></td></tr>
                    </table>
                  </div>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  if ($ACTIVATION_STATUS=="COMPLETE") {
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                      <div class="x_panel">
                        <div class="x_title">
                          <strong>OFFICIAL USE: </strong> For Completer
                          <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                          ...
                          <?php
                          # ... 02: Get Creator's Name
                          $OAA_COREID = GetUserCoreIdFromWebApp($OAA_USER_ID);
                          $response_msg = FetchUserDetailsFromCore($OAA_COREID, $MIFOS_CONN_DETAILS);
                          //$CONN_FLG = $response_msg["CONN_FLG"];
                          //$RESP_FLG = $response_msg["RESP_FLG"];
                          $ADDED_CORE_RESP = $response_msg["CORE_RESP"];
                          $APPRVD_BY_NAME = $ADDED_CORE_RESP["username"]." (".$ADDED_CORE_RESP["firstname"]." ".$ADDED_CORE_RESP["lastname"].")";
                          ...
                          ?>
                          <label for="fn">Completed By * :</label>
                          <input type="text" class="form-control" disabled="" value="<?php echo $APPRVD_BY_NAME; ?>">

                          <label for="mn">Date Completed :</label>
                          <input type="text" class="form-control" disabled="" value="<?php echo $OAA_DATE; ?>">

                          <label for="ln">Completor's Signature * :</label>
                          <input type="text" class="form-control" disabled="">
