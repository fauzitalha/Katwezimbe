...
<html>
  <head>
    ...
    LoadDeviceSettings(); 
    LoadDefaultCSSConfigurations("Make Direct Deposit", $APP_SMALL_LOGO); 
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              <div class="x_title">
                <h2>Make Direct Deposit of Funds onto Customer Account</h2>
              ...
              <div class="x_content">         
                ...
                <form method="post" id="dmsEEAjj" onsubmit="return Validate(this)">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                    <label>Enter Account Number to Credit:</label>
