...
<html>
  <head>
    ...
    LoadDeviceSettings(); 
    LoadDefaultCSSConfigurations("Disburse Loans Applns", $APP_SMALL_LOGO); 
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              <div class="x_title">
                <h2>Disburse Loans Applications</h2>
                  ...
                  <tbody>
                    ...
                    for ($i=0; $i < sizeof($la_list); $i++) {
                      ...
                      <tr valign="top">
                        ...
                        <td><?php echo number_format($APPROVED_AMT); ?></td>
                        ...
                        <td>
                          <a href="la-disburse-ind?k=<?php echo $data_transfer; ?>" class="btn btn-primary btn-xs">View</a>
                        </td>
                      </tr>
                      <?php
