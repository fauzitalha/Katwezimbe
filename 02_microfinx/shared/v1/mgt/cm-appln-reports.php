          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_content">         
                ...
                <form method="post" action="cm-appln-reports2">
                  ...
                  <select id="filter" name="filter" required="">
                    ...
                    <option value="REVIEW">Applications 4 Review</option>
                    <option value="P_APPROVAL">Pending Approval</option>
                    <option value="P_FINAL">Pending Finalization</option>
                    <option value="COMPLETE">Completed Applications</option>
                    <option value="REJECTED">Rejected Applications</option>
                  </select><br><br>

                  <label for="dob">Application Start Date :</label><br>
                  ...
                  <label for="dob">Application End Date :</label><br>
